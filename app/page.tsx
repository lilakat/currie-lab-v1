    ...
    return (
        <>
            <div className="text-black font-[family-name:var(--font-raleway)]">
                <div className="relative w-full h-[20vh] sm:h-[40vh] flex justify-center overflow-hidden">
                    <Image
                ...
                <div className="flex flex-col justify-center items-center h-[50vh] sm:h-[20vh] text-center md:px-24">
